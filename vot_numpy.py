...
class VOT:
    def __init__(self, y, x, nu=None, mu=None, lam=None, label_y=None, tol=1e-4, verbose=True):
    ...
    def update_map(self, i, dist, max_iter=3000, lr=0.5, beta=0, lr_decay=200, stop=200, reg=0., keep_idx=False, space='euclidean'):
        ...
        for it in range(max_iter):
            ...
            # TODO: The rest of the function employs a very shallow 1st-order gradient descent
